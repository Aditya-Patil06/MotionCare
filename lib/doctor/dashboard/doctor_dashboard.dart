              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      healthProfile?.conditionNotes ??
                          'Mild distal biceps tendinopathy.',
                      style: const TextStyle(
                        fontSize: 13,
                        color: AppTheme.textLight,
                        height: 1.35,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  (healthProfile?.affectedBodyPart ??
                                          'Right Elbow')
                                      .split(' / ')
                                      .first,
                                  style: const TextStyle(
                          ...
                          child: OutlinedButton.icon(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => PatientHealthProfileScreen(
                          ...
                          child: TextButton.icon(
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                      SessionReviewScreen(sessionRecord: s),
                                ),
                              );
                            },
                          ),
            ...
            children: [
              ...
              if (plan.isClinicianOverridden)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppTheme.stateInsufficientVisibility.withOpacity(
                      0.15,
                    ),
