...
import 'package:physio_app/patient/exercise/personalized_guidance_painter.dart';

void main() {
  group('PersonalizedGuidancePainter Movement Guidelines', () {
    testWidgets('Renders Bicep Curl guidelines with target sector and ghost line', (tester) async {
      final landmarks = {
    ...
    testWidgets('Renders Shoulder Raise guidelines with shoulder vertex and abducted arm', (tester) async {
      final landmarks = {
    ...
    testWidgets('Handles unscaled pixel coordinates from camera stream gracefully', (tester) async {
      final landmarks = {
        'right_shoulder': const Landmark(x: 360.0, y: 250.0, likelihood: 0.99),
