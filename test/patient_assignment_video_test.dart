...
void main() {
  ...
  testWidgets('Doctor assigns plan to patient and patient receives plan and video', (WidgetTester tester) async {
    ...
    expect(find.textContaining('Left Shoulder / Rotator Cuff'), findsOneWidget);
